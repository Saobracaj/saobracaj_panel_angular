...
@Component({
  selector: 'app-question-preview-overlay',
  standalone: true,
  imports: [
    CommonModule,
    MatCardModule,
  ...
  templateUrl: './question-preview-overlay.component.html',
  styleUrl: './question-preview-overlay.component.scss'
})
export class QuestionPreviewOverlayComponent implements OnDestroy {
